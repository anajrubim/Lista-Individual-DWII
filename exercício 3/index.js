function pegarValor() {
    ...
    if(rastreamento == true){
        paragrafo.innerHTML = `Taxa de Rastreamento: 200,00\n <br> Valor do frete pelas peças: ${frete}\n <br> Valor do frete por quilômetro:${freteKm}\n <br> Total do frete:${total + 200}`;
    }
    else{
        paragrafo.innerHTML = `Taxa de Rastreamento: 0,00\n <br> Valor do frete pelas peças: ${frete}\n <br> Valor do frete por quilômetro:${freteKm}\n <br> Total do frete:${total}`;
    }
}
