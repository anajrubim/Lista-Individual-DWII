function pegarValor() {
    ...
    paragrafo.innerHTML = `código do funcionário: ${codigo} <br>
                             número de horas trabalhadas: ${totalHorasTrabalhadas} <br>
                             valor da hora trabalhada: R$ ${valorHora.toFixed(2)} <br>
                             salário inicial: R$ ${salarioInicial.toFixed(2)} <br>
                             auxílio alimentação: R$ ${auxAlimentacao.toFixed(2)} <br>
